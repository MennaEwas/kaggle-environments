...
async function renderer({
  ...
  const rects = {
    ...
    flame: [
      "#FF972E;6,4,2,1,4;4,11,2,1,4;9,10,2,1,4;1,18,2,1,4;6,17,2,1,4;",
      "#FEF545;6,5,2,1,4,.5;4,12,2,1,4,.5;9,11,2,1,4,.5;1,19,2,1,4,.5;6,18,2,1,4,.5;",
    ],
    shipyard: [
      "0,9,1,3,8;1,5,1,5,15;3,2,1,7,15;2,3,2,8,15;1,5,2,9,15;0,7,10,3,15;",
      "8,2,2,8,8;",
      "#000B49;4,8,1,1,15;5,6,1,3,15;6,5,2,4,15;8,4,1,5,15;",
    ],
    explosion: [
