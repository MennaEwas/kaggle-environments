...
def attacker_agent(board):
    ...
    for idx, shipyard in enumerate(shipyards):
        ...
        if closest_enemy_shipyard and (remaining_halite >= spawn_cost or shipyard.ship_count >= 50):
            if shipyard.ship_count >= 50:
                ...
                shipyard.next_action = ShipyardAction.launch_ships_in_direction(50, flight_plan)
...
def simp_agent(board):
    ...
    for shipyard in shipyards:
        ...
        elif remaining_halite > 500 and shipyard.max_spawn > 5:
...
def random_agent(board):
    ...
    for shipyard in shipyards:
        ...
        if randint(0, 3) == 0 and shipyard.ship_count > 10:
            ...
            shipyard.next_action = ShipyardAction.launch_ships_in_direction(min(10, math.floor(shipyard.ship_count / 2)), flight_plan)
        # else spawn if possible
        elif remaining_halite > board.configuration.spawn_cost * shipyard.max_spawn:
            remaining_halite -= board.configuration.spawn_cost
